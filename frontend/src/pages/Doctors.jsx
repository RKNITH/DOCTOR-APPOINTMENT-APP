...
const Doctors = () => {
    ...
    return (
        <div>
            ...
            <div className='flex flex-col sm:flex-row items-start gaps-5 mt-5'>
                <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-primary text-white' : ''}`} onClick={() => setShowFilter(prev => !prev)}>Filters</button>
                <div className={`flex flex-col gap-4 text-sm text-gray-600 p-2 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
